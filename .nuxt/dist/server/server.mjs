...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contact-BbyVD9Ov.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-BcCH7h33.js").then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/projects-DEfJ1Hrv.js").then((m) => m.default || m)
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-Br5_h48C.js").then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-BnpiLwFS.js").then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-CpYOFB-q.js").then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-B4Oh869w.js").then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-D1vyU0rS.js").then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-CT1kpVY5.js").then((r) => r.default));
...
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-CLxOMfdZ.js").then((r) => r.default));
...
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-B_H6PsPW.js").then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-DO3IkVtJ.js").then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-CxWbG_ll.js").then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-CA0ZzIPq.js").then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-BusX5ZNJ.js").then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-Em_T0A-c.js").then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-swhHzCwF.js").then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-wEnBUPse.js").then((r) => r.default));
...
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-BIoHL19F.js").then((r) => r.default));
...
const plugin_xypFjC7cJN = /* @__PURE__ */ defineNuxtPlugin(() => ({
  provide: {
    mail: {
      send: async (config2) => {
        try {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "max-w-2xl mx-auto text-gray-400 dark:text-gray-600 text-sm text-center pb-8" }, _attrs))}><br><p>© 2025 Benjamin Cahn. All rights reserved.</p></footer>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D7WkPUBR.js").then((r) => r.default || r));
